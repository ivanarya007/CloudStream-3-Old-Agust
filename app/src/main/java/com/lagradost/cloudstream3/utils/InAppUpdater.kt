...
class InAppUpdater {
    companion object {
        ...
        private fun Activity.getReleaseUpdate(): Update {
            val url = "https://api.github.com/repos/Stormunblessed/CloudStream-3/releases"
        ...
        private fun Activity.getPreReleaseUpdate(): Update = runBlocking {
            val tagUrl =
                "https://api.github.com/repos/Stormunblessed/CloudStream-3/git/ref/tags/pre-release"
